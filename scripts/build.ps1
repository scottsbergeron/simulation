...
Write-Host "Building CitySimGame for platform: $Platform"
...
if (!(Test-Path "$targetDir/CitySimGame.exe") -and !(Test-Path "$targetDir/CitySimGame")) {
...
Write-Host "  Windows: .\publish\windows\CitySimGame.exe"
Write-Host "  Mac: ./publish/mac/CitySimGame"
Write-Host "  Linux: ./publish/linux/CitySimGame"
Write-Host "`nTo run the game:"
Write-Host "  Windows: .\publish\windows\CitySimGame.exe"
Write-Host "  Mac: chmod +x ./publish/mac/CitySimGame && ./publish/mac/CitySimGame"
Write-Host "  Linux: chmod +x ./publish/linux/CitySimGame && ./publish/linux/CitySimGame" 